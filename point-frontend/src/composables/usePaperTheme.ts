...
export const PAPER_THEMES: PaperTheme[] = [
  { key: 'jade',   label: '象牙 · 玉白', bg: '#fdfaf6', nav: '#f4f1eb', text: '#2c2416', text2: '#8b7e6a', border: '#e8e0d5' },
  { key: 'jinsu',  label: '金粟 · 暖黄', bg: '#fcf7ee', nav: '#f3edde', text: '#2c2416', text2: '#8b7e6a', border: '#ece3d2' },
