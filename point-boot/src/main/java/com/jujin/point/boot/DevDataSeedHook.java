...
final class DevDataSeedHook implements RuntimeHook {
    ...
    public void start(Container container) {
        ...
        String pw = Passwords.hash("123456");
        ...
        U[] users = {
            new U(
                "墨客",
                "moke",
                "https://api.dicebear.com/9.x/notionists/svg?seed=Moke",
                "静心写字，安然读书。一纸墨痕，半窗月明。"
            ),
            new U(
                "听雨",
                "tingyu",
                "https://api.dicebear.com/9.x/notionists/svg?seed=Tingyu",
                "夜雨敲窗，煮茶读帖。人间有味是清欢。"
            ),
            new U(
                "竹心",
                "zhuxin",
                "https://api.dicebear.com/9.x/notionists/svg?seed=Zhuxin",
                "竹影扫阶尘不动，月轮穿沼水无痕。"
            ),
            new U(
                "山客",
                "shanke",
                "https://api.dicebear.com/9.x/notionists/svg?seed=Shanke",
                "山中无历日，寒尽不知年。"
            ),
            new U(
                "素笺",
                "sujian",
                "https://api.dicebear.com/9.x/notionists/svg?seed=Sujian",
                "素笺淡墨，写不尽人间烟火。"
            ),
        };
        for (var u : users)
        ...
        TP[] topics = {
            ...
            new TP(
                ...
                2,
                null,
                "夜读时分，窗外雨声淅沥。忽然想起苏东坡的\"一蓑烟雨任平生\"，那种豁达，大概是要经历很多才能学会的。",
                0
            ),
            new TP(
                3,
            ...
            new TP(
                ...
                1,
                null,
                "下班路上看到一只橘猫趴在书店门口的台阶上晒太阳，忽然觉得这种慵懒的从容，就是我理想的生活状态 😸",
                0
            ),
            new TP(
                1,
                ...
                2,
                null,
                "今日练字打卡。临《兰亭序》第三遍，终于把\"永和九年\"写得有几分王羲之的意思了。老师说写字不在多，在精。每天二十个字，认认真真写，比敷衍一百个强。",
                0
            ),
            new TP(
                2,
            ...
            new TP(
                ...
                1,
                null,
                "泡了一壶铁观音，翻开一本旧书。纸张微微泛黄，有一股陈年的纸墨香。这种气味，电子书永远替代不了。",
                0
            ),
            new TP(
                3,
                ...
                2,
                null,
                "分享一个有意思的发现：写字的时候放白噪音（雨声、海浪声）比听歌更专注。可能因为人声和旋律会占用大脑的语言处理区域，而自然声音不会。\n\n大家码字/写代码的时候听什么？",
                0
            ),
            new TP(
                5,
        ...
        for (var tp : topics) {
            db.execute(
                "INSERT INTO bbs_topic (create_time,type,category_id,user_id,title,content,status,qa_status,view_count,comment_count,like_count,last_comment_time,bounty_score,solved_at,recommend,recommend_time,sticky,sticky_time) VALUES (?,?,?,?,?,?,1,?,0,0,0,?,0,0,false,0,false,0)",
                t,
                tp.ty(),
                tp.ci(),
                tp.u(),
        ...
        CM[] comments = {
            new CM(
                ...
                "topic",
                1,
                "写得真好。我也特别喜欢《围城》，每年都会翻一遍，每次都能读出不一样的东西。",
                0
            ),
            new CM(
                3,
            ...
            new CM(
                ...
                "topic",
                1,
                "说到幽默中的冷眼，想起鲁迅。鲁迅是热肠的冷眼，钱锺书是智者的冷眼。各有味道。",
                0
            ),
            new CM(
                2,
                "topic",
                3,
                "建议正文直接用 16px，17px 在移动端有点大。另外行高 1.7 比 1.9 更舒服。",
                0
            ),
            new CM(
                5,
            ...
            new CM(
                ...
                "topic",
                3,
                "移动端不要缩小字号，但要保证最大宽度。16-17px 在手机上也很舒服。",
                0
            ),
            new CM(
                3,
                "topic",
                6,
                "即刻的排版确实不错。另外推荐少数派和 Typography 正刊。",
                0
            ),
            new CM(
                1,
                "topic",
                9,
                "47 篇帖子、31 本书、三个省份 —— 这真是一个丰盛的年头。佩服你的坚持 ✨",
                0
            ),
            new CM(
                2,
            ...
            new CM(
                ...
                "topic",
                4,
                "橘猫是最懂生活的哲学家 😂 我家楼下也有一只，每天固定时间在同一个位置晒太阳。",
                0
            ),
            new CM(
                5,
                "topic",
                2,
                "写字和做事的道理一样。少即是多，慢即是快。",
                0
            ),
        };
        for (var c : comments)
            db.execute(
                "INSERT INTO bbs_comment (create_time,user_id,entity_type,entity_id,content,quote_id,like_count,comment_count,status) VALUES (?,?,?,?,?,?,0,0,1)",
                t,
                c.u(),
                c.et(),
                c.ei(),
        ...
        var artContent = """
            ...
            欢迎在评论区分享你的碎片收集方法。""";
        db.execute(
            "INSERT INTO bbs_article (create_time,update_time,user_id,title,summary,content,content_type,status,view_count,comment_count,like_count) VALUES (?,?,?,?,?,?,?,1,0,0,0)",
            t,
            t,
            1L,
            "关于保存「碎片想法」的一些思考",
        ...
        CM[] artComments = {
            ...
            new CM(
                ...
                "article",
                1,
                "想问一下，你是用哪个工具来做碎片管理的？我试过 Notion、Obsidian 和 flomo，各有优劣。",
                0
            ),
        };
        ...
        for (var f : follows)
            db.execute(
                "INSERT INTO bbs_user_follow (user_id,other_id,status,create_time) VALUES (?,?,1,?)",
                f[0],
                f[1],
                t
            );
        ...
        for (var l : likes)
            db.execute(
                "INSERT INTO bbs_user_like (user_id,entity_type,entity_id,create_time) VALUES (?,?,?,?)",
                l[0],
                l[1],
                l[2],
                t
        ...
        // --- fix user counts ---
        db.execute(
            "UPDATE bbs_user SET topic_count = (SELECT COUNT(*) FROM bbs_topic WHERE user_id = bbs_user.id AND status = 1)"
        );
        db.execute(
            "UPDATE bbs_user SET comment_count = (SELECT COUNT(*) FROM bbs_comment WHERE user_id = bbs_user.id AND status = 1)"
        );
        db.execute(
            "UPDATE bbs_user SET follow_count = (SELECT COUNT(*) FROM bbs_user_follow WHERE user_id = bbs_user.id AND status = 1)"
        );
        db.execute(
